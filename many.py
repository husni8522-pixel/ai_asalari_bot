...
"ари","асалари ич кетиши","асаларим","қишки озуқа","арилар","асал","асаларичилик","асаларичи","ари оиласи","қиролича","она ари",
    "ишчи ари","эркак ари","қанди","канди","нуклиус","асалариларим","матка","трутен","ари уяси","катта уя","кичик уя",
    "кўп қаватли уя","бўлинма уя","рамка","катак","сота","панжара","мумли асос","асали панжара","асал ажратгич",
    "асал экстрактори","асал пичоғи","асаларичи кийими","ниқоб","қўлқоп","тутатувчи","димар","медогонка","ари заҳри",
    "қироллик сути","перга","гулчанг","прополис","мум","хоникомб","озиқлантириш","шакар","сироп","канди","баҳорги озиқлантириш",
    "кузги озиқлантириш","қандари","тоғ ари","сувли ари","қуёшли ари","италян ари","карлик ари","кавказ ари","рус ари",
    "европейс ари","карника ари","ҳимолай ари","африк ари","медонос ари","ёввойи ари","асл ари","ўзбек ари","қора ари",
    "шакарли ари","ўрта европалик ари","даволаш","профилактика","дори","кимёвий даволаш","органик даволаш","оксалат кислотаси",
    "формик кислотаси","тимол","касалликлар","варроа","нозема","акарапидоз","американ чириши","европа чириши","вирус",
    "замбуруғ","ари касаллиги","жараёнлар","бузилишни олдини олиш","самарадорлик","хани харвест","сварм превеншн","фидинг сироп",
...
"quyoshli ari","italyan ari","karlik ari","kavkaz ari","rus ari","yevropeys ari","karnika ari","himalay ari","afrik ari",
"medonos ari","yovvoyi ari","asl ari","o‘zbek ari","qora ari","shakarli ari","o‘rta yevropalik ari",
