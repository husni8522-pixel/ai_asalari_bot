...
"italyan ari","италян ари","italian bee","итальянская пчела",
"karnika ari","карника ари","carnica bee","карника",
"kavkaz ari","кавказ ари","caucasian bee","кавказская пчела",
"karpat ari","карпат ари","carpathian bee","карпатская пчела",
"rus ari","рус ари","russian bee","русская пчела",
...
"ishchiar","ишчиар","worker bee","рабочая пчела",
"erkakar","эркакар","drone bee","трутень",
"trutten","труттен","drone","трутень",
"matkaa","маткаа","queen","матка",
"ariuyasi","ариуяси","hive","улей",
"kattauya","каттауя","large hive","большой улей",
"kichikuya","кичикуя","small hive","малый улей",
...
"bolakatak","бола катак","brood frame","расплодная рамка",
"katakk","катакк","cell","ячейка",
"sotaa","сотаа","honeycomb","соты",
"mumli asosss","мумли асоссс","wax foundation","вощина",
"panjaraa","панжараа","queen excluder","разделительная решетка",
"asall","асалл","honey","мёд",
"gul asall","гул асалл","flower honey","цветочный мёд",
"togasal","тоғасал","mountain honey","горный мёд",
"pergga","пергга","bee bread","перга",
"gulchangg","гулчанга","pollen","пыльца",
"propoliss","прополисс","propolis","прополис",
"qirolliksuti","қиролликсути","royal jelly","маточное молочко",
"ari zahriii","ари заҳриии","bee venom","пчелиный яд",
"asal ajrttgich","асал ажртгич","honey extractor","медогонка",
"medogonkkka","медогонккка","honey extractor","медогонка",
"asal pichoggi","асал пичогги","uncapping knife","нож для распечатывания",
"tutattuvchi","тутаттувчи","smoker","дымарь",
"dimarr","димарр","smoker","дымарь",
"arikiyimi","арикийими","bee suit","костюм пчеловода",
